      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {(data.categories || []).length > 0 ? (
            ...
            <div className={`col-span-full py-12 text-center ${subtextClass} border-2 border-dashed ${isDark ? 'border-gray-700' : 'border-gray-200'} rounded-2xl`}>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-6">
          {(data.categories || []).length > 0 ? (
            ...
            <div className={`py-12 text-center ${subtextClass} border-2 border-dashed ${isDark ? 'border-gray-700' : 'border-gray-200'} rounded-2xl`}>
               <p className="text-lg font-medium">Add Your Expertise</p>
            </div>
          )}
        </div>
